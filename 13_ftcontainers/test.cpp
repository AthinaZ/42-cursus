...
int main()
{
	...
	std::ofstream fileout ("stlContainers.txt");
	...
	{
		fileout << " : Out of Range error: " << e.what() << std::endl;
	}
  ...
  // set some initial values:
	...
	int stop_c = clock();
	fileout << std::endl;
	fileout << "STL containers execution in microseconds : " <<(stop_c-start_c)/double(CLOCKS_PER_SEC)*1000000 << std::endl; // microseconds
